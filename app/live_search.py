...
endpoint. For keyword searches this module uses the public judgment search
endpoint and then fetches the official judgment pages.
"""
import html
import re
...
def search_official(keyword: str, limit: int = 20):
    ...
    if not keyword:
        return []
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; JudicialCaseSearch/0.5)",
